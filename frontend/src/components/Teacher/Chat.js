  ...
  useEffect(() => {
    const loadChats = async () => {
      ...
      const mockConversations = [
        { id: 1, name: 'Parent of John Doe', lastMessage: 'Thank you for your help!', time: '2:30 PM', unread: 2 },
        { id: 2, name: 'Parent of Jane Smith', lastMessage: 'When is the next test?', time: '1:15 PM', unread: 0 },
        { id: 3, name: 'Parent of Mike Johnson', lastMessage: 'Mike has been improving...', time: 'Yesterday', unread: 1 },
      ];
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        <h1 style={styles.title}>💬 Chat with Parents</h1>
          ...
          {selectedChat ? (
            <>
              <div style={styles.chatHeader}>
                <div style={{ fontSize: '18px', fontWeight: '600', color: '#1f2937' }}>{selectedChat.name}</div>
              </div>
            ...
            <div style={styles.emptyState}>
              ...
              <p>Choose a parent to start chatting</p>
            </div>
          )}
        </div>
      </div>
