// frontend/src/components/Parent/ViewAnnouncements.js
// ✅ PARENT VIEW - Uses authenticated endpoint filtered by parent's linked students' schools
...
const ViewAnnouncements = () => {
  ...
  const fetchAnnouncements = async () => {
    try {
      ...
      // ✅ Uses authenticated endpoint filtered by parent's linked students' schools
      const token = localStorage.getItem('token');
      const response = await fetch(`${API_BASE_URL}/api/mongo/parent/announcements`, {
        method: 'GET',
        headers: {
        ...
        <div style={{
          ...
          {[
            ...
            <button
              ...
              style={{
                padding: '8px 16px',
                border: filter === category.value ? '2px solid #0ea5e9' : '2px solid #e5e7eb',
                borderRadius: '8px',
                backgroundColor: filter === category.value ? '#dbeafe' : 'white',
                color: filter === category.value ? '#075985' : '#6b7280',
                fontSize: '14px',
                fontWeight: '600',
                cursor: 'pointer',
                transition: 'all 0.2s'
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    padding: '24px',
                    boxShadow: '0 2px 8px rgba(0,0,0,0.1)',
                    border: announcement.pinned ? '3px solid #0ea5e9' : 'none',
