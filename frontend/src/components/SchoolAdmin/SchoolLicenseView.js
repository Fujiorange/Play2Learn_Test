            ...
            <strong>
              {licenseInfo.isExpired 
                ...
                : licenseInfo.isNearExpiry 
                  ? 'Free License Expiring Soon' 
                  : 'Free License Active'}
            </strong>
            <p>
              {licenseInfo.isExpired 
                ? 'Your free license has expired. Please upgrade to continue using all features.' 
                : `Your free license expires in ${licenseInfo.daysRemaining} day${licenseInfo.daysRemaining !== 1 ? 's' : ''}.`}
            </p>
          </div>
          {!licenseInfo.isExpired && (
            <button 
