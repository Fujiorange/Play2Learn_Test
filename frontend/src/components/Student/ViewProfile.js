        ...
        <div style={styles.profileSection}>
          ...
          <div style={styles.infoGrid}>
            ...
            <div style={styles.infoItem}>
              ...
              <div style={styles.value}>{user.date_of_birth || 'Not provided'}</div>
            </div>
          </div>
        </div>
        ...
        <div style={styles.profileSection}>
          ...
          <div style={styles.infoGrid}>
            <div style={styles.infoItem}>
              ...
              <div style={styles.value}>{user.grade_level && user.grade_level !== 'Not Set' ? user.grade_level : 'Student'}</div>
            </div>
            <div style={styles.infoItem}>
              <div style={styles.label}>Role</div>
              <div style={styles.value}>Student</div>
            </div>
            <div style={styles.infoItem}>
