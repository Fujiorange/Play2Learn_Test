    ...
    <div style={styles.container}>
      <div style={styles.content}>
        <div style={styles.header}>
          ...
          <button style={styles.backButton} onClick={() => navigate('/student/profile')}>← Back to Profile</button>
        </div>
        ...
        <form style={styles.form} onSubmit={handleSubmit}>
          ...
          <div style={styles.formGroup}>
            ...
            <input type="date" name="dateOfBirth" value={formData.dateOfBirth} onChange={handleChange} disabled={saving} style={styles.input} />
          </div>
          ...
          <div style={styles.buttonGroup}>
            ...
            <button type="button" onClick={() => navigate('/student/profile')} disabled={saving} style={styles.cancelButton}>
              Cancel
            </button>
          </div>
        </form>
