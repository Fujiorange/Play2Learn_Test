...
export default function WriteTestimonial() {
  ...
  const handleSubmit = async (e) => {
    ...
    setMessage({ type: 'success', text: 'Thank you! Your testimonial has been submitted.' });
    setSubmitting(false);
      ...
      <div style={styles.content}>
        ...
        <form style={styles.form} onSubmit={handleSubmit}>
          <div style={styles.formGroup}>
            ...
            <input type="text" value={formData.title} onChange={(e) => setFormData({...formData, title: e.target.value})} required placeholder="e.g., Great learning experience!" style={styles.input} />
          </div>
          <div style={styles.formGroup}>
