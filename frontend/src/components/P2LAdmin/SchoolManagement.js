          ...
          <div className="modal-content">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                ...
                {licenses.length > 0 ? (
                  ...
                  <div style={{ padding: '10px', background: '#fff3cd', borderRadius: '4px', color: '#856404' }}>
                    ⚠️ No licenses found. Please create a license first in License Management.
                  </div>
                )}
              </div>
              ...
              <div className="form-actions">
                <button type="submit" className="btn-submit" disabled={licenses.length === 0}>
            ...
            return (
              <div key={school._id} className="school-card">
                ...
                <div className="school-details">
                  ...
                  {license && (
                    <>
                      <p><strong>License:</strong> {license.name} ({license.type === 'free' ? 'Free' : 'Paid'})</p>
                      <p><strong>Teachers:</strong> {school.current_teachers || 0} / {license.maxTeachers === -1 ? '∞' : license.maxTeachers}</p>
                      <p><strong>Students:</strong> {school.current_students || 0} / {license.maxStudents === -1 ? '∞' : license.maxStudents}</p>
                      <p><strong>Classes:</strong> {school.current_classes || 0} / {license.maxClasses === -1 ? '∞' : license.maxClasses}</p>
                      <p><strong>Price:</strong> ${license.priceMonthly}/month</p>
                    </>
                  )}
                  {!license && <p><em>No license assigned</em></p>}
